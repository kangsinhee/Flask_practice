...
class cuser(db.Model):
    ...
    id = db.Column(db.Integer, primary_key = True, unique = True, nullable = False)   #id를 기본키로 설정
    password = db.Column(db.String(64), unique = True, nullable = False)              #패스워드를 받아올 문자열길이
